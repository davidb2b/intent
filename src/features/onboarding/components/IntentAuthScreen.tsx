  ...
  return <main className="intent-auth-screen">
    <section className="intent-auth-card">
      ...
      <form onSubmit={submit}>
        ...
        <Button disabled={busy} type="submit">{busy && <LoaderCircle className="intent-spin" size={15} />}{mode === "signin" ? "Entrar no Intent" : mode === "signup" ? "Começar agora" : "Enviar instruções"}</Button>
      </form>
