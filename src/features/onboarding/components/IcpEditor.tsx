  ...
  return <main className="intent-icp-main">
    <div className="intent-icp-container">
      ...
      <section className="intent-icp-section">
        ...
        <div className="intent-two-columns">
          <div className="intent-card"><EditableList disabled={!editable} label="Dores do comprador" minItems={8} maxItems={8} onChange={(values) => change((next) => { next.buyingSignals.dores = values })} values={icp.buyingSignals.dores} variant="rows" /></div>
        ...
        <div className="intent-card"><EditableList disabled={!editable} label="Temas relevantes" maxItems={12} onChange={(values) => change((next) => { next.buyingSignals.temas = values })} placeholder="Adicionar tema..." values={icp.buyingSignals.temas} /></div>
